...
class AlibabaProductPostMultilanguageAeProductParam {
...
"attrNameId": 186
    ...
    */
        ...
        $tempResult = $this->sdkStdResult["couponStartDate"];
        return $tempResult;
    }
    
    /**
     * 设置卡券商品开始有效期     
     * @param Date $couponStartDate     
     * 参数示例：<pre>20160119113420000+0800</pre>     
     * 此参数必填     */
    public function setCouponStartDate( $couponStartDate) {
        $this->sdkStdResult["couponStartDate"] = $couponStartDate;
    }
    ...
    */
        ...
        $tempResult = $this->sdkStdResult["couponEndDate"];
        return $tempResult;
    }
    
    /**
     * 设置卡券商品结束有效期     
     * @param Date $couponEndDate     
     * 参数示例：<pre>20160124113420000+0800</pre>     
     * 此参数必填     */
    public function setCouponEndDate( $couponEndDate) {
        $this->sdkStdResult["couponEndDate"] = $couponEndDate;
    }
    ...
    */
        public function getMultilanguageSubject() {
        $tempResult = $this->sdkStdResult["multilanguageSubject"];
        return $tempResult;
    }
    
    /**
     * 设置多语言标题，长度不能超过218个字符。     
     * @param String $multilanguageSubject     
     * 参数示例：<pre>Название нескольких языков</pre>     
     * 此参数必填     */
    public function setMultilanguageSubject( $multilanguageSubject) {
        $this->sdkStdResult["multilanguageSubject"] = $multilanguageSubject;
    }
    ...
    */
        public function getMultilanguageDetail() {
        $tempResult = $this->sdkStdResult["multilanguageDetail"];
        return $tempResult;
    }
    
    /**
     * 设置多语言详描，长度不能超过90000个字符。     
     * @param String $multilanguageDetail     
     * 参数示例：<pre>Многоязычный подробное описание</pre>     
     * 此参数必填     */
    public function setMultilanguageDetail( $multilanguageDetail) {
        $this->sdkStdResult["multilanguageDetail"] = $multilanguageDetail;
    }
    ...
    */
        ...
        $tempResult = $this->sdkStdResult["localeName"];
        return $tempResult;
    }
    ...
    public function setLocaleName( $localeName) {
        $this->sdkStdResult["localeName"] = $localeName;
    }
    ...
    */
        public function getUseAutoTrans() {
        $tempResult = $this->sdkStdResult["useAutoTrans"];
        return $tempResult;
    }
    
    /**
     * 设置是否使用自动翻译，如果带上这个参数，则localeName必须为ru_RU，并且会自动把多语言标题和描述通过机器翻译自动翻译成英文，覆盖传人的英文描述和标题里面     
     * @param Boolean $useAutoTrans     
     * 参数示例：<pre>true</pre>     
     * 此参数必填     */
    public function setUseAutoTrans( $useAutoTrans) {
        $this->sdkStdResult["useAutoTrans"] = $useAutoTrans;
    }
