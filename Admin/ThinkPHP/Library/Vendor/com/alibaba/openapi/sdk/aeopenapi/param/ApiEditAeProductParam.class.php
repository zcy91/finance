...
include_once ('com/alibaba/openapi/sdk/aeopenapi/param/AlibabaproductAeopAEMultimedia.class.php');
...
其中"attrNameId","attrValueId"为整型(Integer), "attrName", "attrValue"为字符串类型(String)。
    ...
    * @return 商品的多媒体信息。
    */
        public function getAeopAEMultimedia() {
        $tempResult = $this->sdkStdResult["aeopAEMultimedia"];
        return $tempResult;
    }
    
    /**
     * 设置商品的多媒体信息。     
     * @param AlibabaproductAeopAEMultimedia $aeopAEMultimedia     
     ...
     * 此参数必填     */
    public function setAeopAEMultimedia(AlibabaproductAeopAEMultimedia $aeopAEMultimedia) {
        $this->sdkStdResult["aeopAEMultimedia"] = $aeopAEMultimedia;
    }
