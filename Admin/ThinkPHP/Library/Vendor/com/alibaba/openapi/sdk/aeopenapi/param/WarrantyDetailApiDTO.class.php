...
1.notSubmit(未提交)2.create（创建）3.cancel（取消）4.finish（完成）     
    ...
    */
    ...
    private $productLeafCategoryId;
    
        /**
    * @return 产品叶子类目id
    */
        public function getProductLeafCategoryId() {
        return $this->productLeafCategoryId;
    }
    
    /**
     * 设置产品叶子类目id     
     * @param Integer $productLeafCategoryId     
     * 参数示例：<pre>111</pre>     
     * 此参数必填     */
    public function setProductLeafCategoryId( $productLeafCategoryId) {
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->snapshotId = $this->stdResult->{"snapshotId"};
    			    		    				    			    			...
    			    		    				    			    			if (array_key_exists ( "productLeafCategoryId", $this->stdResult )) {
    				$this->productLeafCategoryId = $this->stdResult->{"productLeafCategoryId"};
    			}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->snapshotId = $arrayResult['snapshotId'];
    		    	    			    		    			...
    		    	    			    		    			if (array_key_exists ( "productLeafCategoryId", $this->arrayResult )) {
    			$this->productLeafCategoryId = $arrayResult['productLeafCategoryId'];
    			}
