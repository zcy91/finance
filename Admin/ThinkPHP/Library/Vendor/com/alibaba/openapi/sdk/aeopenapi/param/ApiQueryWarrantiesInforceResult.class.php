...
include_once ('com/alibaba/openapi/sdk/aeopenapi/param/WarrantyInforceApiDTO.class.php');

class ApiQueryWarrantiesInforceResult {
    ...
    */
    ...
    /**
     * 设置     
     * @param array include @see WarrantyInforceApiDTO[] $dataList     
          
     * 此参数必填     */
    public function setDataList(WarrantyInforceApiDTO $dataList) {
		...
		$this->stdResult = $stdResult;
    			...
    			$dataListResult=$this->stdResult->{"dataList"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$WarrantyInforceApiDTOResult=new WarrantyInforceApiDTO();
						$WarrantyInforceApiDTOResult->setArrayResult($arrayobject );
						$this->dataList [$i] = $WarrantyInforceApiDTOResult;
					}
    			}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$dataListResult=$arrayResult['dataList'];
    			$this->dataList = WarrantyInforceApiDTO();
