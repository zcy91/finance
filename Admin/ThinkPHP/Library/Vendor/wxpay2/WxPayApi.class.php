...
use Vendor\wxpay\WxPayException;
...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
        public static $wx_config = null;
        
        public static function set_wx_config($wx_config){
        ...
        public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(self::$wx_config['appid']);//公众账号ID
		$inputObj->SetMch_id(self::$wx_config['mchid']);//商户号
